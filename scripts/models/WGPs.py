...
class Generator(nn.Module):
    def __init__(self, latent_dim, seq_len, vocab_size):
        ...
        self.fc = nn.Linear(self.latent_dim, 32*self.seq_len)
    ...
    def forward(self, z):
        out = self.fc(z)
        out = out.view(out.shape[0], 32, self.seq_len)  # Reshape to correct dimensions
...
class Discriminator(nn.Module):
    def __init__(self, seq_len, vocab_size):
        ...
        # Output layer
        self.fc = nn.Linear(16*self.seq_len//4, 1) # 2 times of stride of 2
